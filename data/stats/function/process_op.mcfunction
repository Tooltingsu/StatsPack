...
execute if score @s st_op matches 10..17 run scoreboard players set #display st_sys 0
...
# 刷新
execute if score @s st_op matches 10..17 run function stats:rotate
execute if score @s st_op matches 10..17 run title @a actionbar {"text":"📊 管理员切换了榜单","color":"aqua"}
